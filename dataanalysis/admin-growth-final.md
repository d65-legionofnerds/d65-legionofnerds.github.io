...
*Underlying CSV data is available at [data/d65_admin_comp_combined.csv](data/d65_admin_comp_combined.csv) (PA disclosures) and [data/afr_admin_pool_summary.csv](data/afr_admin_pool_summary.csv) (AFR pool). Source AFR Excel files are in [data/afr/](https://github.com/d65-legionofnerds/d65-legionofnerds.github.io/tree/main/dataanalysis/data/afr){:target="_blank"}. Build scripts for the dataset and visualizations are in [build_admin_growth_data.py](build_admin_growth_data.py), [build_afr_admin_pool.py](build_afr_admin_pool.py), and [build_admin_growth_final_charts.py](build_admin_growth_final_charts.py).*
