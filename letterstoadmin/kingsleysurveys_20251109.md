...
<li>6. Both surveys do not limit the number of responses per respondent. This makes it impossible to accurately measure the Kingsley community’s opinion.</li>

<li>7. It is not clear how the data will be used by the school or by the administration. This needs to be articulated to potential respondents to ensure relevant responses that are within scope. Many potential respondents will not have an intuitive sense of how this data might be useful.</li>
</ol>
