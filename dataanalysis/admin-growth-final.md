...
- **Lincolnwood Elementary (conditional trigger)** — The January 2026 resolution states: "If by October 2026 the District has not achieved financial sustainability and the district-wide average K-5 building utilization rate is below 75%, the Board will recognize the need to propose the closure of Lincolnwood Elementary School." Not yet voted; estimated incremental annual savings ≈ **$1.57M** (Scenario 2D minus Scenario 1A: $3,235,277 − $1,662,529). *(Source: [foiagras doc 13846](https://ig.foiagras.com/api/public/chat/documents/13846/view){:target="_blank"}; SDRP III revised model 12.1.25, [foiagras doc 12033](https://ig.foiagras.com/api/public/chat/documents/12033/view){:target="_blank"}.)*
