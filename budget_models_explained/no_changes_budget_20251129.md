...
This piece begins with definitions of key terms. [Click here to skip to the explanation.](#budget-model-explanation)
...
There are two types of expenses that are considered when organizations are budgeting - [operational expenses](#definitions) and [capital expenses](#definitions). This table covers operating expenses only. 
